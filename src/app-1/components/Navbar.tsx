    ...
    <nav className="fixed w-full z-50 top-0 border-b border-gray-200 dark:border-white/5 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button className="bg-brand-DEFAULT hover:bg-brand-dark dark:bg-white/5 dark:hover:bg-white/10 dark:border dark:border-white/10 text-white px-5 py-2.5 rounded-full text-sm font-medium transition-all shadow-lg shadow-brand-light/20 dark:shadow-none">
            Connect Wallet
          </button>
        </div>
      </div>
